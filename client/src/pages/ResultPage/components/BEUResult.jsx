...
export const BUEResult = ({ RegistrationNumber }) => {
  ...
  return (
    <section className="w-full max-w-[1440px] m-auto">
      ...
      {/* Description */}
      <div className="mt-12">
        <p className="text-danger">The results for a Registration Number cannot be found because of any of the following reasons</p>
        <ul>
          <li><TfiHandPointRight />You may have entered a Wrong Registration Number.</li>
          <li><TfiHandPointRight />Your Registration Number does not belong to B.Tech.</li>
